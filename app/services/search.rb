...
#'active','arts','auto','beautysvc','education','eventservices','financialservices','food','health','homeservices','nightlife','pets','hotelstravel','localflavor','localservices','massmedia','professional','publicservicesgovt',
    categories = ['realestate','religiousorgs','restaurants','shopping']
