...
class Search
  ...
  def scrape_businesses
    ...
    categories = ['nightlife','publicservicesgovt','realestate','religiousorgs','restaurants','shopping']
    #'active','arts','auto','beautysvc','education','eventservices','financialservices','food','health','homeservices',
    # 'pets','hotelstravel','localflavor','localservices','massmedia','professional',
